...
function createInitialStore(): MockStore {
  ...
  return {
    ...
    alerts: [
      { id: "alt_1", ts: isoMinutesAgo(8), severity: "warn", message: "VPIN entered amber zone on ETH/USDT." },
      { id: "alt_2", ts: isoMinutesAgo(27), severity: "info", message: "Backtest bt_1002 completed with robust score 80.5." },
      { id: "alt_3", ts: isoMinutesAgo(40), severity: "error", message: "Temporary requote burst detected on BTC/USDT." },
    ],
    logs: [
      { id: "log_1", ts: isoMinutesAgo(2), severity: "info", module: "execution", message: "Order accepted by policy engine." },
      { id: "log_2", ts: isoMinutesAgo(6), severity: "warn", module: "risk", message: "Spread near configured limit.", related_id: "tr_1017" },
      { id: "log_3", ts: isoMinutesAgo(14), severity: "debug", module: "signals", message: "Consensus score 0.71 for BTC/USDT." },
      { id: "log_4", ts: isoMinutesAgo(25), severity: "error", module: "exchange", message: "429 received from ticker endpoint." },
    ],
    gateChecklist: [
