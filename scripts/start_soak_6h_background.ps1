...
$stdoutPath = Join-Path $artifactsDir "soak_6h_bg_stdout.log"
$stderrPath = Join-Path $artifactsDir "soak_6h_bg_stderr.log"
...
Write-Host "Soak 6h lanzado en segundo plano."
Write-Host "PID: $($p.Id)"
Write-Host "Status: artifacts\\soak_6h_bg_status.json"
Write-Host "StdErr: artifacts\\soak_6h_bg_stderr.log"
Write-Host "Done: artifacts\\soak_6h_bg_*_DONE.txt"
